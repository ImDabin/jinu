    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (itemId) {
                    case HOME_ID:
                        startActivity(new Intent(offer.this, home.class));
                        return true;
                    case OFFER_ID:
                        return true;
                    case PUSH_ID:
                        startActivity(new Intent(offer.this, push.class));
                        return true;
                    case CHAT_ID:
                        startActivity(new Intent(offer.this, chat.class));
                        return true;
                    case MY_ID:
                        startActivity(new Intent(offer.this, mypage.class));
                        return true;
                    default:
                        return false;
                }
