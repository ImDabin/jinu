    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (itemId) {
                    case HOME_ID:
                        startActivity(new Intent(goods3.this, home.class));
                        return true;
                    case OFFER_ID:
                        startActivity(new Intent(goods3.this, offer.class));
                        return true;
                    case PUSH_ID:
                        startActivity(new Intent(goods3.this, push.class));
                        return true;
                    case CHAT_ID:
                        return true;
                    case MY_ID:
                        startActivity(new Intent(goods3.this, mypage.class));
                        return true;
                    default:
                        return false;
                }
